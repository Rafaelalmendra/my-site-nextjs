      ...
      >
        <UlLinks>
          <Link href='/' style={{ textDecoration: 'none' }}>
            <a><li onClick={() => props.isMenu && props.closeMenu()}>Home</li></a>
          </Link>
          <Link href='/Projects' style={{ textDecoration: 'none' }}>
            <a><li onClick={() => props.isMenu && props.closeMenu()}>Projetos</li></a>
          </Link>
          <Link href='/Blog' style={{ textDecoration: 'none' }}>
            <a><li onClick={() => props.isMenu && props.closeMenu()}>Blog</li></a>
          </Link>
